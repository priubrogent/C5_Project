...
def parse_args():
    ...
    p.add_argument('--augmented_annotations', action='store_true', default=False,
                   help='Use the augmented training dataset (train_augmented and train_augmented.json)')
    return p.parse_args()
...
def main():
    ...
    if args.augmented_annotations:
        train_img_dir = os.path.join(args.data_root, 'train_augmented')
        train_ann = os.path.join(args.data_root, 'annotations', 'train_augmented.json')
        val_ann   = os.path.join(args.data_root, 'annotations', 'val_filtered.json' if args.filtered_annotations else 'val.json')
        print("Using AUGMENTED training dataset!!")
    elif args.filtered_annotations:
